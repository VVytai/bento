...
///
/// The walk, the budgets and the caching all mirror `tray/webext`'s
...
final class LibraryIndex {
    ...
    private let domain = "page.bento.tray.documents"
    private let queue = DispatchQueue(label: "page.bento.tray.index", qos: .utility)
