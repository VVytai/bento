...
//
// Serves the bento/home cross-origin probe on TWO origins.
//
...
// question the whole per-document-runner design rests on (docs/DECISIONS.md,
// 2026-08-02) — if a delegated handle cannot write, bento/home cannot open a
// document safely and the design needs rethinking.
//
...
const root = join(dirname(fileURLToPath(import.meta.url)), '..', 'home')
...
serve(PARENT_PORT, 'home')
serve(RUNNER_PORT, 'runner')
console.log(`
